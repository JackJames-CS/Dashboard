...
const navItems = [
  ...
  { to: '/ai-agents', icon: 'ai', label: 'AI Agents' },
  { to: '/automation', icon: 'automation', label: 'Automation' },
...
const icons = {
  ...
  work: (
    <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M21 13.255A23.931 23.931 0 0112 15c-3.183 0-6.22-.62-9-1.745M16 6V4a2 2 0 00-2-2h-4a2 2 0 00-2 2v2m4 6v.01M12 16v.01M16 20v.01M12 8v.01M8 20v.01M4 20v.01" /></svg>
  ),
  projects: (
...
export default function Sidebar() {
  return (
    <aside className="w-[var(--sidebar-width)] flex-shrink-0 bg-white border-r border-surface-200/80 flex flex-col py-4">
